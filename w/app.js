const names = ['Lounis Bouhaddada' , 'Pere Riera' , 'Miguel Santana' , 'Pol Martín', 'Amaia Moneo', 'Héctor González', 'Helena Pont de Roda', 'David Arribas', 'Andrea Alonso','Marina Cama']; // Array con los nombres 
